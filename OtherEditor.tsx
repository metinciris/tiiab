...
export const templates: Record<ReportMode, ReportTemplate> = {
  tiiab: {
    ...
    pageNumber: 1,
    pageLabel: 'Tiroid',
    title: 'Tiroid sitoloji raporlama',
    shortTitle: 'Tiroid',
    defaultLocation: 'Tiroid',
    locationSuggestions: ['Tiroid'],
    specimenText: () => 'Tiroid; İnce iğne aspirasyon biyopsisi; sıvı bazlı sitoloji',
  ...
  lap: {
    ...
    pageNumber: 2,
    pageLabel: 'Diğer',
    title: 'Tiroid loju / Paratiroid / LAP raporlama',
    shortTitle: 'Diğer',
